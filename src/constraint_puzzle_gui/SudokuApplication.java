...
public class SudokuApplication extends SingleFrameApplication {
    ...
    @Override protected void startup() {
        ...
        if(applicationModel.justCreated()) {
            JOptionPane.showMessageDialog(applicationView.getComponent(), "It appears that this is your first time running the application. To begin, select New Collection from the File menu.", "In The Beginning", JOptionPane.INFORMATION_MESSAGE);
        }
    }
