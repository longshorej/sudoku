...
public class AddPuzzlesDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(constraint_puzzle_gui.SudokuApplication.class).getContext().getResourceMap(AddPuzzlesDialog.class);
        setTitle(resourceMap.getString("Form.title")); // NOI18N
        setName("Form"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(constraint_puzzle_gui.SudokuApplication.class).getContext().getActionMap(AddPuzzlesDialog.class, this);
