...
/**
 * An implementation of a SudokuPuzzle,
 * extending the concept of a Constraint Puzzle.
 * 
 * @author Jason Longshore <longshorej@gmail.com>
 * @author Mat Folz <folzm@gmail.com>
 * @author Mark Johnson <johnsonm469@gmail.com>
 * @author Jason Sedlack <in2theriver@gmail.com>
 * @author Nick Mactavish
 */
...
//            System.out.println("deficalty: " +  easyPuzzle.getRating());
...
//            System.out.println("deficalty: " + mediumPuzzle.getRating());
...
//            System.out.println("deficalty: " + hardPuzzle.getRating());
...
//            System.out.println("deficalty: " + cannidateLineTest.getRating());
...
//            System.out.println("deficalty: " + doublePairTest.getRating());
...
//            System.out.println("deficalty: " + nakedPair.getRating());
...
//            System.out.println("deficalty: " + xWing.getRating());
            ...
            System.out.println("deficalty: " + swordFish.getRating());
    ...
    /**
     * Loads a Sudoku 9x9 constraint puzzle in the format used at the bottom
     * of the Wikipedia Sudoku algorithmics page.
     * 
     * @param text the representation of the Sudoku. Blanks are periods.
     * @return ConstraintPuzzle the equivalent ConstraintPuzzle
     * @throws Sudoku.ElementValueViolatesRuleException If the Sudoku passed violates rules, this is thrown
     */
    ...
    //    System.out.print("GetRatingCalled()");
        ...
        if( isSolved() ) {
          //  System.out.println(" 0 techniques used");
              ...
              //      System.out.println("Used TechniqueSingleInRow");
               ...
               //    System.out.println("Used TechniqueSingleInRegion");
                ...
                //    System.out.println("Used CandidateLine");
                    while(copy.applyTechniqueElimination()) { easyMovesUsed++; }
                    mediumMovesUsed++;
            ...
            System.out.println("    Esy: " + easyMovesUsed);
            System.out.println("    Med: " + mediumMovesUsed);
     ...
     /**
     * Applys one elimination step. This encompasses many 
     * elimination techniques, as many are slight variations
     * of the same concept.
     * 
    ...
    public boolean applyTechniqueCandidateLines() {
        ...
        try {
            ...
            for (int currentBlock = 0; currentBlock < this.getSize()/*ex:9*/; currentBlock++) {
                // the upper-left-most element in the block.
                int blockFirstElement = currentBlock * blockLineLength/*ex:3*/ + (int) Math.floor(currentBlock / blockLineLength) * 2 * puzzleLineLength;
                            ...
                            if (firstCandidateStorageArray[0] == secondCandidateStorageArray[0] && firstCandidateStorageArray[1] == secondCandidateStorageArray[1]) {
                                ...
                                for (int j = 0; j < puzzleSize && checkRowCellNumber < puzzleSize*puzzleSize; j++) {
                                    if (elementWithNumberIsEmpty(checkRowCellNumber) && checkRowCellNumber != tmpRowNumber && checkRowCellNumber != emptyNumber) {
                                        ...
                                        System.out.println("Before row remove:");
                                        System.out.println(beforeRemove);
                                        */
...
//                                    System.out.println("EXITING TRUE! - ROW");
          ...
          /*      Integer[] tmpCandidateStorageArray = this.validElementsCache.get(emptyNumber).toArray(secondCandidateStorageArray);
                System.out.print(emptyNumber);
                System.out.print(":");
    ...
    /*Multi Line*/
    /**
     * This method is implementing the x-wing technique to eleminate canidates for a given cell.
     * @return true if the technique was used other wise false
     */
    public boolean applyTechniqueXWing() {
        //System.out.println("Trying X-Wing");
        /* how it works
         * scan each colums/row for a number that can only be in two spots.
         * then scan the colums/rows of those numbers for another number that meats
        those condisions
         * then remove that number from all other locations but those 4.
         */
    ...
    public boolean applyTechniqueSwordfish() {
         ...
         * then scan the colums/rows of those numbers for another number that meats
        those condisions
         * then remove that number from all other locations but those 6.
         */
...
//                        }
     ...
     * If it finds it the specified number of times then it returns the locations of that value.
     * If it finds it more than the specified then it return an empty set.
     * @param value is the value that it is trying to fine.
     * @param startPoint is the starting point for the searching.
     * @param numberOfFinds allows you to turn off the find the number once thing. by setting it 0 it will find all locations of the number.
     * @return
     */
    ...
    private Set<Integer> findGivenValueInCol(int value, int startPoint, int numberOfFinds) {
        ...
        if (numberOfFinds == 0) {
            ...
            startPoint = startPoint + nextColCellNumber;
        }*/
    ...
    @Override
    // this is jason l's rewrite of jason s's
    public SudokuPuzzle getNewStartState(int tDiff) {
        return getNewStartState(tDiff, SudokuPuzzle.getCopy(this));
    }
    /*Forcing Chains*/
    
    // jason l's, TWEAKED for friday presentation and mostly easy difficulty.....
    public SudokuPuzzle getNewStartState(int tDiff, SudokuPuzzle working) {
     //   System.out.println("#Empty: " + working.emptyElements.size());
        ...
        if(removedElement) {
            if(currentRating == Difficulty.UNKNOWN) currentRating = working.getRating().getDifficulty();
